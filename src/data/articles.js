...
export const articles = [
  ...
  },
  {
    ...
    content: [
      ...
      'Whether you need emergency diesel top-up during a monsoon power outage or an urgent cylinder replacement during restaurant dinner rush, Zyphuel provides rapid 20–45 minute standard dispatch (or 10–20 minute urgent dispatch) throughout Lahore with digital invoicing, standard Rs. 280 delivery fee (+Rs. 100 urgent surcharge), and doorstep fuel capacity ranging strictly from 5 Litres to 15 Litres maximum per single order.'
    ]
  },
  {
    id: 5,
  ...
  },
  {
    ...
    content: [
      ...
      'Today, Zyphuel’s fleet operates 24/7 across Lahore, servicing corporate distribution fleets, residential communities, educational institutes, and emergency backup systems. Doorstep consumer orders are calibrated between 5 Litres minimum and 15 Litres maximum per bowser dispatch for rapid 20–45 minute urban navigation, supported by a transparent Rs. 280 delivery fee. The platform’s logistics backend coordinates automated route dispatch, driver safety tracking, and inventory replenishment directly with licensed Euro-V petroleum oil terminals.',
