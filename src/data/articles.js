...
export const articles = [
  ...
  },
  {
    ...
    content: [
      ...
      'Whether you need emergency diesel top-up during a monsoon power outage or an urgent cylinder replacement during restaurant dinner rush, Zyphuel provides rapid doorstep delivery strictly within 45 minutes throughout Lahore with digital invoicing, standard Rs. 280 delivery fee (+Rs. 100 urgent priority surcharge), and doorstep fuel capacity ranging strictly from 5 Litres to 15 Litres maximum per single order.'
    ]
  },
  {
    id: 5,
  ...
  },
  {
    ...
    content: [
      ...
      'Today, Zyphuel’s fleet operates 24/7 across Lahore, servicing corporate distribution fleets, residential communities, educational institutes, and emergency backup systems. Doorstep consumer orders are calibrated between 5 Litres minimum and 15 Litres maximum per bowser dispatch for rapid doorstep delivery within 45 minutes, supported by a transparent Rs. 280 delivery fee. The platform’s logistics backend coordinates automated route dispatch, driver safety tracking, and inventory replenishment directly with licensed Euro-V petroleum oil terminals.',
