...
const TRENDING_GLOBAL_KEYWORDS = "perol price in Pakistan, fuel price in pakistan, desil price in pakistan, gas price in paksitan, oil price in Pakistan, petrol price cheker wesbite, diesel, diesel gasoline, patrol and diesel, i want diesel, fuel, OGRA fuel rates, Asia cup, Asian games, ICC, t20 world cup, ODI world cup, test match, pak vs Australia, pak vs india, pak vs Bangladesh, pak vs new Zealand, pak vs Sri Lanka, pak vs Ireland, pak vs Afghanistan, pak vs Zimbabwe, pak vs south Africa, pak vs west indies, pak vs England, upcoming cricket matches, aus vs ban, aus vs ind, t20 league's, t10 leagues, linkedln, facebok, reels, Zyphuel, zphuel, ItxMDK, itxmdk, itxmtk, MuhammadDaniel, itsmdk, itx dk, itxM, itcM, Poke nexus, PokeNexus, Muhammad Daniyal, Dashacart, Dasha Cart, Hittop, Hit top, Scale verse, ScaleVerse, Ladoni, Pakistan number 1 fuel brand, Pakistan number 1 fuel agency, Pakistan number 1 fuel suppliers, Pakistan number 1 best fuel delivery, best services in Pakistan, mobile application for fuel suppliers, fuel delivery app Lahore, on-demand energy logistics"
