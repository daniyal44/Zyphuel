# Page Documentation: Terms of Use Page

## Overview & Identity
- **Page Name**: Terms of Use / Service Agreement
- **Route**: `/terms/`
- **Component File**: `src/pages/TermsOfUsePage.jsx`
- **Primary Purpose**: Defines the legal and operational terms governing the use of Zyphuel’s mobile fuel delivery services, digital platforms, pricing calculations, delivery dispatch obligations, safety protocols, and liability limitations in Lahore, Pakistan.

---

## SEO & Structured Data
- **Page Title**: `Terms of Use | Zyphuel Fuel Delivery`
- **Meta Description**: `The terms that govern your use of the Zyphuel website and Android app for fuel delivery in Lahore, including orders, payment, delivery, and dispute resolution.`
- **Schema Type**: `WebPage`

---

## Key Terms & Legal Framework
1. **Acceptance of Terms**:
   - Binding agreement for all users accessing the website, Android APK, or telephone dispatch.
2. **Use of Service**:
